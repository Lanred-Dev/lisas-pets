...
<div class={twMerge("relative", classes)}>
    ...
    <input class="w-full rounded-normal border border-border bg-backgroundSecondary px-3 py-1 placeholder-[#F5F5F5] outline-none" {placeholder} {type} {value} data-id={id} bind:this={input} on:focusin={focus} on:keyup={focus} />
</div>
